<section class="content">
      <div class="row">
        <div class="col-md-3">
          <a class="btn btn-primary btn-block margin-bottom" href="#" onclick="loadContent(base_url + 'view/View_pesan_baru');">Tambah Pesan</a>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              <div class="mailbox-controls">
                <!-- Check all button -->
                <button class="btn btn-default btn-sm checkbox-toggle" type="button"><i class="fa fa-square-o"></i>
                </button>
                <div class="btn-group">

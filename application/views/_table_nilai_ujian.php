<section class="content">
	<div class="box">
        ...
        <div class="box-body">
         <div id="loading"></div>
         <a href="#" onclick="loadContent(base_url + 'view/_nilai_ujian_form');" class="btn btn-success pull-right"> Add Nilai Ujian</a>
...
function konfirmasiHapus(x){
 if(confirm("Yakin hapus Data???")){
  ...
  setTimeout(function() {
    $.ajax({
      url: base_url + 'manage',
      data: 'model-input=nilai_ujian&key-input=id_ujian&action-input=3&value-input=' + x,
      dataType: 'json',
      type: 'POST',
      cache: false,

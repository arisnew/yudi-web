    ...
    <div class="container">
        <div class="row">
            <div id="content" class="col-xs-12">
                ...
                <br>
                <div class="col-md-3">Nama Guru</div>
                <div class="col-md-9">: <b><?php echo $soal->nama;?></b></div>
                <br>
                <div class="col-md-3">Nama Mapel</div>
                <div class="col-md-9">: <b><?php echo $soal->nama_mapel;?></b></div>
                <br>
                <div class="col-md-3">Nama Materi</div>
                <div class="col-md-9">: <b><?php echo $soal->judul;?></b></div>
                <br>
                <div class="col-md-3">Tanngal Posting</div>
                <div class="col-md-9">: <b><?php echo $soal->tgl_posting;?></b></div>
                <br>

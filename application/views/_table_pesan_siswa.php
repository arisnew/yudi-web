<section class="content">
    <div class="box">
        ...
        <div class="box-body">
            <div id="loading"></div>
            <a href="#" onclick="loadContent(base_url + 'view/_form_pesan_siswa');" class="btn btn-success pull-right">Tambah Pesan</a>
...
<script type="text/javascript">
    ...
    function utils() {
        $("#tabel-pesan .editBtn").on("click",function(){
            loadContent(base_url + 'view/_form_pesan_siswa/' + $(this).attr('href').substring(1));
        });
    ...
    function utilspesanmasuk() {
        $("#tabel-pesan-masuk .readBtn").on("click",function(){
            loadContent(base_url + 'view/_view_pesan_siswa/' + $(this).attr('href').substring(1));
        });
                ...
                $.ajax({
                    ...
                    success: function(json) {
                        ...
                        if (json['data'].code === 1) {
                            ...
                            loadContent(base_url + "view/_table_pesan_siswa");

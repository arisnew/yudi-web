<section class="content">
    <div class="box">
        ...
        <div class="box-body">
            <div id="loading"></div>
            <a href="#" onclick="loadContent(base_url + 'view/_form_siswa');" class="btn btn-success pull-right">Tambah Data Siswa</a>
...
<script type="text/javascript">
    ...
    function utils() {
        $("#tabel-siswa .editBtn").on("click",function(){
            loadContent(base_url + 'view/_form_siswa/' + $(this).attr('href').substring(1));
        });
